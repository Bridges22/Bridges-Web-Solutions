    ...
    <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-red-500 to-pink-500 text-white px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg shadow-red-500/30 animate-glow-pulse">
            <span className="w-2 h-2 bg-white rounded-full animate-ping"></span>
            <span>NEW SERVICES LAUNCHED</span>
            <i className="ri-sparkling-line ml-2"></i>
          </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 h-full">
                ...
                <div className="p-8 lg:p-10 relative">
                  {/* NEW Badge */}
                  <div className="absolute top-4 right-4 md:right-auto md:left-4 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg shadow-red-500/50 animate-pulse">
                    NEW
                  </div>
